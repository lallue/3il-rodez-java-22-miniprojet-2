...
/**
 * La classe Chemin représente un chemin sur une carte, composé d'une liste de
 * cases.
 * Elle fournit des méthodes pour accéder aux cases du chemin et afficher le
 * chemin.
 */
public class Chemin {
    ...
    /**
     * Affiche le chemin sur la console en affichant les coordonnées et les tuiles
     * de chaque case.
     */
